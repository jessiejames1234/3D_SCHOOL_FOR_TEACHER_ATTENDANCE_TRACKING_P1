  ...
  return (
    <div className="attendance-container">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .gps-btn:hover { background-color: #2b6cb0; }
        .qr-btn {
          background-color: #38a169;
          color: #ffffff;
        }
        .qr-btn:hover:not(:disabled) { background-color: #2f855a; }
        .qr-btn:disabled { background-color: #cbd5e0; cursor: not-allowed; }
        .attendance-banners {
          display: flex;
        ...
        .status-banner, .error-banner, .success-banner, .info-banner, .warning-banner, .error-banner-box {
          padding: 12px 16px;
          border-radius: 8px;
          font-size: 0.9rem;
          line-height: 1.4;
        }
        .status-banner { background-color: #f7fafc; border: 1px solid #e2e8f0; color: #4a5568; }
        .error-banner, .error-alert, .error-banner-box { background-color: #fff5f5; border: 1px solid #fed7d7; color: #c53030; }
        .error-alert { padding: 12px 16px; border-radius: 8px; margin-bottom: 12px; }
        .success-banner { background-color: #f0fff4; border: 1px solid #c6f6d5; color: #276749; margin-top: 8px; }
        .info-banner { background-color: #ebf8ff; border: 1px solid #bee3f8; color: #2b6cb0; }
        .warning-banner { background-color: #fffaf0; border: 1px solid #feebc8; color: #dd6b20; }
        .test-user-btn { background: #e2e8f0; border: none; padding: 6px 12px; border-radius: 4px; font-weight: 600; cursor: pointer; }
        .attendance-grid {
          display: grid;
        ...
        .clear-qr-btn:hover { color: #e53e3e; }
        .gps-mini-debug {
          background: #ffffff;
          border: 1px solid #e2e8f0;
          border-radius: 8px;
          ...
          <div className="attendance-right">
            <div className="status-panel">
              ...
              <div className="qr-status-box">
               ...
               {connectionQuality && (
                 <div className="gps-mini-debug" style={{ marginTop: 8 }}>
                   <div className="panel-label mt-2">WiFi SPEED</div>
                   <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                     ...
                     <span style={{ color: '#666' }}>{connectionQuality.rtt !== null ? `${connectionQuality.rtt}ms` : ''}{connectionQuality.effectiveType && connectionQuality.effectiveType !== 'offline' ? `, ${connectionQuality.effectiveType}` : ''}</span>
                   </div>
                 </div>
               )}
